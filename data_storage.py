...
def store_data_to_sqlite(data, table_name):
    conn = sqlite3.connect('advertising_data.db')
    cursor = conn.cursor()
...
if __name__ == "__main__":
    ...
    store_data_to_sqlite(standardized_impressions, 'Impressions')
    store_data_to_sqlite(unique_clicks_conversions, 'ClicksConversions')
    store_data_to_sqlite(correlated_data, 'CorrelatedData')
